# 1) 숙제
https://html-preview.github.io/?url=https://github.com/YeweonJung/basic-study/blob/main/R%20study/Functional%20Connectivity%20of%20RS-fMRI.html
# 2) afni practice
DTI DICOM 데이터를 NIfTI로 변환하고, Gradient 정규화와 노이즈 제거(Denoising/Degibbs)를 거쳐 뇌 지표(FA, MD 등) 맵 생성 및 통계 검증
file://wsl.localhost/Ubuntu-22.04/home/jyo52622/prof_practice_analysis/DTI_analysis/DTI_Report.html
# 3) 2026-02-04
...
# 6) 한 피험자의 fMRI 데이터를 촬영 차수별(Run-01, 02)로 전처리하여 머리 움직임과 신호 정밀도(tSNR)를 loop를 이용하여 자동 비교 분석했고,  Run-01을 후속 분석용 데이터로 최종 선정하는 과정
